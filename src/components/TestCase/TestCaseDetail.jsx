...
export default ({caseId, userMap, setExecuteStatus, project}) => {
  ...
  const CaseTitle = <Col span={24}>
    ...
    <Button type='primary' className={styles.inlineButton} onClick={execute} loading={loading}><PlayCircleOutlined/>执行</Button>
                ...
                <Col span={24}>
                  ...
                  <Tabs defaultActiveKey="1" style={{marginTop: 12}}>
                    <TabPane key="1" tab="基础信息">
                      <Descriptions borderd bordered size='middle' column={2}>
